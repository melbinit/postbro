...
import { BarChart2, ArrowLeft, Check } from "lucide-react"
...
export default function SignupPage() {
    ...
    const syncWithBackend = async () => {
      if (isSignedIn) {
        try {
          ...
          console.warn('Backend sync failed, but Clerk signup succeeded:', error)
  ...
  const benefits = [
    "Discover why posts go viral with AI analysis",
    "Get similar post ideas for your next content",
    "Analyze images, videos, and captions instantly",
    "Understand engagement metrics that matter"
  ]
    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-background">
      ...
      <div className="hidden md:flex w-1/2 bg-muted/30 relative overflow-hidden flex-col p-12 justify-between border-r border-border">
        ...
        <div className="relative z-10 max-w-md">
          <h2 className="text-3xl font-bold mb-6">Create content that goes viral</h2>
          <p className="text-muted-foreground text-lg mb-6 leading-relaxed">
            Stop guessing what works. Use AI to decode successful posts and generate winning ideas for your next viral content.
          </p>
